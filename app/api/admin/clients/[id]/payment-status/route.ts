...
export async function PUT(request: NextRequest, { params }: { params: { id: string } }) {
  ...
  try {
    ...
    if (body.paymentStatus) updateClientPaymentStatus(params.id, body.paymentStatus);
    if (body.accountStatus) updateClientAccountStatus(params.id, body.accountStatus);
